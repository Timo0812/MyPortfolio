const translations = {
  en: {
    ...
    project_gg_desc1: "A daily guessing game inspired by the One Piece universe. Players must identify 3 mystery characters each day using clues like gender, crew, devil fruit, etc. Visual feedback (green, yellow, red) and directional arrows guide players toward the correct answer.",
    project_gg_desc2: "Built with Vue.js 3 and TypeScript on the frontend, featuring a responsive design with Tailwind CSS and smooth animations. The backend runs on Node.js serverless functions deployed on Vercel, exposing a REST API for daily character selection and search functionality.",
    project_gg_desc3: "The project implements game state persistence via localStorage, a hint system unlocked after 10 attempts, and Google AdSense integration for monetization (not active). A custom hash algorithm ensures varied daily character selection across the 150+ complete characters database.",
    project_gg_serverless: "Vercel Serverless Functions",
    project_gg_hosting1: "Vercel Platform for hosting",
    project_gg_skill1: "Development of a modern, interactive game design interface, fully responsive",
    project_gg_skill2: "Building a backend system to manage game logic and user interactions",
    ...
    project_ga_desc1: "Led the complete design, development, and deployment of a professional showcase website for Gest-Azur Sàrl, a Swiss insurance brokerage serving clients throughout Switzerland.",
    ...
    project_ga_skill2: "Implementation of a dynamic contact form with validation UX/UI optimization for the insurance sector",
    ...
    project_ce_desc1: "Design and development of an automated evaluation system for sensory panels, analyzing multiple key parameters. The project combines advanced VBA functions handling complex cases (tied values, nulls) with multi-criteria evaluation logic generating global scores per attribute.",
    project_ce_desc2: "The solution integrates ranking algorithms tolerant to variations, intelligent detection of rating trends, and a configurable rules system. The modular architecture and comprehensive documentation ensure maintainability and enable future evolution toward modern web technologies.",
    ...
    project_ce_skill5: "Technical communication (complex concept simplification)",
  ...
  fr: {
    ...
    project_gg_date: "Jan. 2026",
    project_gg_desc1: "Un jeu de devinettes quotidien inspiré de l'univers One Piece. Les joueurs doivent identifier 3 personnages mystères chaque jour en utilisant des indices comme le genre, l'équipage, le fruit du démon, etc. Un retour visuel (vert, jaune, rouge) et des flèches directionnelles guident les joueurs vers la bonne réponse.",
    project_gg_desc2: "Développé avec Vue.js 3 et TypeScript côté frontend, avec un design responsive grâce à Tailwind CSS et des animations fluides. Le backend fonctionne sur des fonctions serverless Node.js déployées sur Vercel, exposant une API REST pour la sélection quotidienne de personnages et la fonctionnalité de recherche.",
    project_gg_desc3: "Le projet implémente la persistance de l'état du jeu via localStorage, un système d'indices débloqué après 10 tentatives, et l'intégration de Google AdSense pour la monétisation (non active). Un algorithme de hachage personnalisé assure une sélection quotidienne variée de personnages parmi plus de 150 personnages complets dans la base de données.",
    project_gg_serverless: "Fonctions Serverless Vercel",
    project_gg_hosting1: "Plateforme Vercel pour l'hébergement",
    project_gg_skill1: "Développement d'une interface de jeu moderne et interactive, entièrement responsive",
    project_gg_skill2: "Construction d'un système backend pour gérer la logique du jeu et les interactions utilisateur",
    ...
    project_ga_date: "27 Sep. 2025",
    project_ga_desc1: "Direction de la conception, du développement et du déploiement complets d'un site vitrine professionnel pour Gest-Azur Sàrl, un courtier en assurances suisse servant des clients dans toute la Suisse.",
    ...
    project_ga_skill1: "Développement d'une interface utilisateur moderne et intuitive",
    project_ga_skill2: "Implémentation d'un formulaire de contact dynamique avec validation et optimisation UX/UI pour le secteur des assurances",
    ...
    project_ce_desc1: "Conception et développement d'un système d'évaluation automatisé pour panels sensoriels, analysant de multiples paramètres clés. Le projet combine des fonctions VBA avancées gérant les cas complexes (valeurs ex aequo, nulles) avec une logique d'évaluation multicritère générant des scores globaux par attribut.",
    project_ce_desc2: "La solution intègre des algorithmes de classement tolérants aux variations, une détection intelligente des tendances de notation, et un système de règles configurable. L'architecture modulaire et la documentation complète assurent la maintenabilité et permettent une évolution future vers des technologies web modernes.",
    project_ce_techstack: "Stack Technique",
    project_ce_excel: "Formules Excel avancées",
    project_ce_skill1: "Gestion des structures de données (Collections, Tableaux)",
    project_ce_skill2: "Logique conditionnelle complexe (gestion de cas multiples)",
    ...
    project_ce_skill5: "Communication technique (simplification de concepts complexes)",
