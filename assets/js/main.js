(function () {
  ...
  on("click", ".mobile-nav-toggle", function (e) {
    ...
    if (navbar.classList.contains("navbar-mobile")) {
      ...
      navbarUl.classList.add("slide-out");
      setTimeout(() => {
        navbar.classList.remove("navbar-mobile");
        navbarUl.classList.remove("slide-out");
  ...
  /**
   * Initialize Typed.js (used for language switching)
   */
  ...
  if (expandableBoxes.length > 0) {
    expandableBoxes.forEach((box) => {
      box.addEventListener("click", function () {
        // Simply toggle this box (allows multiple boxes to be open)
  ...
  document.addEventListener("visibilitychange", function () {
    if (document.hidden) {
      ...
      if (portfolioDetailsSlider && portfolioDetailsSlider.autoplay) {
